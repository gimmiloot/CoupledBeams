...
Проверка механизма в неоднородной H/L/L/H EB/RLB при mu=0,.01:
[RLB-D09](decisions.md#rlb-d09), [RLB-K11](knowledge.md#rlb-k11),
[контрольные точки, два локальных эффекта и четыре рисунка](../laminated_beams/inplane_spring_robustness.md).
Это ограниченная выборка с отдельными квалификациями, не новые полные карты.
Завершение для поставленной цели и следующий теоретический вопрос:
[RLB-D10](decisions.md#rlb-d10),
[научный итог и граница этапа](../laminated_beams/inplane_spring_robustness.md#научный-итог-и-граница-завершения-этапа).
Первый KV-пилот выполнен по [RLB-D11](decisions.md#rlb-d11):
[RLB-K12](knowledge.md#rlb-k12), [теория, 16 состояний и проверки](../laminated_beams/inplane_kelvin_voigt_pilot.md).
