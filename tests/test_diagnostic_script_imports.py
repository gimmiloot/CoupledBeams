...
class DiagnosticScriptImportTest(unittest.TestCase):
    def test_diagnostic_entrypoints_import(self) -> None:
        modules = [
            ...
            "scripts.analysis.anisotropic_rods.audit_yartsev_ch2_limited_3d_fem_readiness",
            ...
            "scripts.analysis.thickness_mismatch.audits.audit_article_epsilon_smoke_failures",
            "scripts.analysis.thickness_mismatch.audits.audit_article_epsilon_solver_readiness_v2",
            "scripts.analysis.thickness_mismatch.audits.audit_family_inventory_local_repair",
            "scripts.analysis.thickness_mismatch.audits.run_article_epsilon_upper_envelope_grid",
            "scripts.analysis.thickness_mismatch.benchmarks.benchmark_article_epsilon_prefix_optimization",
